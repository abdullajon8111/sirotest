            ...
            <div class="container-fluid px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" onclick="alert('Testlar sahifasi keyingi versiyada qo\'shiladi')">
                                <i class="fas fa-clipboard-check me-2"></i>Testlar
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" onclick="alert('Natijalar sahifasi keyingi versiyada qo\'shiladi')">
                                <i class="fas fa-chart-line me-2"></i>Natijalar
                            </a>
                        </li>
                    </ul>
